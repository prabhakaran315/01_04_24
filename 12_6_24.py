...
try:
    ...
    def true_pf_pdf():
        ...
        global export_file_name, selected_directory, selected_file_name, export_dir_name, selected_font, font_frame
        font_frame.destroy()
        test_font.destroy()
        print("Font style : ", f'{selected_font.get()}')
        status_p4_entry.config(text="Export initiated...")
        font_style_pdf = f"{selected_font.get()}"
        if export_dir_name == '':
            export_dir_name = filedialog.asksaveasfilename(title="Export As",
        ...
        header_run.font.name = font_style_pdf
        print(f"font for the header : ",font_style_pdf)
        ...
        try:
            ...
            #output_cont.font.name = font_style_pdf
        ...
        for i, (heading, width) in enumerate(zip(headings_1, column_widths_1)):
            ...
            for paragraph in cell.paragraphs:
                paragraph.alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
                #paragraph.font.name = font_style_pdf
        ...
        runner.bold = True
        runner.italic = True
        runner.font.name = font_style_pdf
        ...
        para = doc.add_paragraph()
        bold_para = para.add_run(''' \n Advanced Power Quality''')
        bold_para.font.name = font_style_pdf
        section = doc.sections[0]
