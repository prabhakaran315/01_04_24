...
try:
    ...
    def export_to_pdf():
        ...
        global number_of_entries, export_dir_name, export_file_name, selected_directory, selected_file_name, sugg_labels_1, all_label
    ...
    def fetch_comment_box_message():
        ...
        if (astranotebook.index(astranotebook.select()) == 3):
            # page -1 comment box fetch the mage event
            global page4_comment_box_message
    ...
    def compile_save_data():
        ...
        sizing_data = {
            ...
            'out_put_content': output_content['text'],
        }
        #Label(astrap4_frame, text = sizing_data['p4_sugg_labels']).place(x=30, y=30)
    ...
    def import_nfo_data():
        ...
        try:
            ...
            try:
                ...
                output_content.config(text=str(imported_data['out_put_content']))
                imported_sugg = imported_data['p4_sugg_labels']
                #Label(astrap4_frame, text = "helo").place(x=10, y=100)
    ...
    def update_results(*args):
        ...
        output_content.config(text="", borderwidth=0)
                    ...
                    if high_pf_entry.get():
                        if lpf <= 1.0 and hpf <= 1.0:
                            if lpf < hpf:
                                ...
                                unit_diff_value_1 = float(round((kva_1 - kw_val) * 24,2))
