...
Label(frame_2, text="Recommendation", font=("Arial", 11), bg=background_color).pack(anchor=N)

#Label(frame_2, text="", bg=background_color).pack(anchor=N)
Label(astrap4_frame, text="", bg=background_color, font=("Arial", 5)).pack()
...
Label(frame_5, text="Suggestion", font=("Arial", 11), bg=background_color).pack(anchor=N)
...
Label(frame_1, text="Primary value of transformer", bg=background_color, fg="Black", font=("Arial", 11)).place(relx=0.35, rely=0.48, anchor=W)
primary_entry = Entry(frame_1, textvariable=primary, font=("Arial", 11))
primary_entry.place(relx=0.52, rely=0.48, anchor=W)

Label(frame_1, text="Secondary value of transformer", bg=background_color, fg="Black", font=("Arial", 11)).place(relx=0.35, rely=0.75, anchor=W)
