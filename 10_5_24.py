...
def condition_1(pri_val, sec_val, cal_opt_val):
    ...
    for x in range(len(rec_tab_val)):
        for y in range(len(rec_tab_val[0])):
            ...
            rec_table = Label(frame_4, text=rec_tab_val[x][y], width=20, anchor="center", bg=background_color,
                              borderwidth=1, relief="solid", font=font_style)
            rec_table.grid(row=x, column=y, padx=0, pady=0, sticky="nsew")
    ...
    sugg_lable_head_1 = Label(table_frame, text="Optimal Panel Rating Based on Optimum kW", font=("Arial", 11, "bold"),
                              bg=background_color)
    ...
    sugg_lable_head_3 = Label(table_frame, text="Panel Rating", font=("Arial", 10, "bold"), bg=background_color,
                              width=15)
    ...
    for i in range(min(3, len(minimum_kw))):
        ...
        sugg_pan_id = Label(table_frame, text=category, font=("Arial", 10), bg=background_color, width=15).grid(
            row=row_index, column=0, padx=5, pady=5)
        sugg_pan_rat = Label(table_frame, text=str(data), font=("Arial", 10), bg=background_color, width=15).grid(
            row=row_index, column=1, padx=5, pady=5)
        sugg_pan_kw = Label(table_frame, text=str(opt_ct_ratio), font=("Arial", 10), bg=background_color,
                            width=15).grid(row=row_index, column=2, padx=5, pady=5)
        row_index += 1
